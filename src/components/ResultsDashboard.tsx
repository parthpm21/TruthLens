...
export const ResultsDashboard: React.FC = () => {
  ...
  const formatMediaType = (media: string) => {
    return media.charAt(0).toUpperCase() + media.slice(1).toLowerCase();
  };
      ...
      <div className="flex flex-wrap gap-3 items-center justify-between">
        <div className="flex items-center gap-3">
          <button
            ...
            className="p-2.5 rounded-xl bg-white border border-slate-200 text-slate-505 hover:text-slate-800 hover:border-slate-400 transition-all duration-150 shadow-sm"
          >
          ...
          <div>
            <div className="flex items-center gap-2.5">
              ...
              <span className="font-sans text-[10px] text-slate-400 font-semibold tracking-wider hidden sm:inline uppercase">
                {formatMediaType(currentResult.mediaType)} · Forensic Report
              </span>
            </div>
            <h2 className="text-lg font-bold tracking-tight text-slate-850 mt-0.5 font-sans">
              Authenticity Analysis Dashboard
            </h2>
          </div>
        </div>
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-white border border-slate-200 hover:border-slate-400 text-slate-750 hover:text-slate-900 font-sans text-xs transition-all duration-150 disabled:opacity-50 shadow-sm font-semibold"
        >
          {isDownloading ? (
            <>
            ...
            <>
              <Download className="w-3.5 h-3.5" weight="regular" />
              Forensic PDF
            </>
          )}
        </button>
            ...
            <div className="p-5 space-y-4">
              ...
              <div className="flex flex-wrap items-center justify-between gap-4 pt-1">
                ...
                <div className="flex items-center gap-3 flex-1 min-w-0">
                  <Sliders className="w-4 h-4 text-slate-450 flex-shrink-0" weight="regular" />
